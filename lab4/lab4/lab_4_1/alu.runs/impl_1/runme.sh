...
HD_PWD='/home/ubuntu/桌面/new_lab/lab_4_1/alu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SglCirCPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SglCirCPU.tcl -notrace
