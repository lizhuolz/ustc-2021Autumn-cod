...
HD_PWD='/home/ubuntu/new_lab/my_lab5/my_lab5.runs/mem_data_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_data.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem_data.tcl
